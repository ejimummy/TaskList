...
public class DBAdapter {
	...
	// DB info: it's task, and the table we are using (just one).
	...
	public long insertRow(String task, int status) {
		/*
		 * CHANGE 3:
		 */		
	...
	public int getNumberOfRows() {
		...
		int rowNum = (int) DatabaseUtils.queryNumEntries(db, "mainTable");
		return rowNum;
	}
	...
	public boolean updateRow(long rowId, String task, int status) {
		String where = KEY_ROWID + "=" + rowId;
